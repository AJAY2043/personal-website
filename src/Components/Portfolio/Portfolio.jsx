  ...
  return (
    <section id="portfolio" className="portfolio-section">
      ...
      <div className="project-card">
        ...
        <a href="https://github.com/yourusername/ar-mart" className="project-link" target="_blank" rel="noopener noreferrer">View Project</a>
      </div>
      ...
      <div className="project-card">
        ...
        <a href="https://github.com/yourusername/shopper" className="project-link" target="_blank" rel="noopener noreferrer">View Project</a>
      </div>
      ...
      <div className="project-card">
        ...
        <a href="https://github.com/yourusername/whereismyforeman" className="project-link" target="_blank" rel="noopener noreferrer">View Project</a>
      </div>
    </section>
  );
};
